...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'elara_db', 'user' => 'postgres', 'password' => '32841488house', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Jupiter/UsuariosBundle/Entity'))), 'Jupiter\\UsuariosBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('JupiterUsuariosBundle' => 'Jupiter\\UsuariosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e2146233aec10c7db12ceeeae8823f5df1ae81a8a40f024c7aa28b067cec82e6');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Jupiter/UsuariosBundle/Resources/views'), 'JupiterUsuarios');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JupiterUsuariosBundle' => 'Jupiter\\UsuariosBundle\\JupiterUsuariosBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'elara_db',
            'database_user' => 'postgres',
            'database_password' => '32841488house',
